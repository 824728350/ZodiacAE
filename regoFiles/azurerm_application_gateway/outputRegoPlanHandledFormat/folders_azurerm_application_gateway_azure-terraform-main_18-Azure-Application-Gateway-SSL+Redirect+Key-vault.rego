...
mock_config := {
        ...
        "root_module": {
            "outputs": {
                "azurerm_key_vault_certificate_id": {
                    "expression": {
                        "references": [
                            "azurerm_key_vault_certificate.my_cert_1.id",
                            "azurerm_key_vault_certificate.my_cert_1"
                        ]
                    }
                },
                "azurerm_key_vault_certificate_secret_id": {
                    "expression": {
                        "references": [
                            "azurerm_key_vault_certificate.my_cert_1.secret_id",
                            "azurerm_key_vault_certificate.my_cert_1"
                        ]
                    }
                },
                "azurerm_key_vault_certificate_version": {
                    "expression": {
                        "references": [
                            "azurerm_key_vault_certificate.my_cert_1.version",
                            "azurerm_key_vault_certificate.my_cert_1"
                        ]
                    }
                },
                ...
                "storage_account_primary_web_endpoint": {
                    "expression": {
                        "references": [
                ...
                "user_assigned_identity_client_id": {
                    "expression": {
                        "references": [
                            "azurerm_user_assigned_identity.appag_umid.client_id",
                            "azurerm_user_assigned_identity.appag_umid"
                        ]
                    }
                },
                ...
                "user_assigned_identity_principal_id": {
                    "expression": {
                        "references": [
                            "azurerm_user_assigned_identity.appag_umid.principal_id",
                            "azurerm_user_assigned_identity.appag_umid"
                        ]
                    }
                },
                "user_assigned_identity_tenant_id": {
                    "expression": {
                        "references": [
                            "azurerm_user_assigned_identity.appag_umid.tenant_id",
                            "azurerm_user_assigned_identity.appag_umid"
                        ]
                    }
                },
            ...
            "resources": [
                        ...
                        "http_listener": [
                            ...
                            },
                            {
                                ...
                                "ssl_certificate_name": {
                                    "references": [
                                        "local.ssl_certificate_name_keyvault"
                                    ]
                                }
                            }
                        ],
                ...
                {
                    "address": "azurerm_key_vault_access_policy.key_vault_default_policy",
                    "expressions": {
                    ...
                    "mode": "managed",
                    "name": "key_vault_default_policy",
                    "provider_config_key": "azurerm",
                    "schema_version": 0,
                    "type": "azurerm_key_vault_access_policy"
                },
                {
                    "address": "azurerm_key_vault_certificate.my_cert_1",
                    "depends_on": [
                        "azurerm_key_vault_access_policy.key_vault_default_policy"
                    ],
                    "expressions": {
                        "certificate": [
                            {
                ...
                {
                    "address": "azurerm_user_assigned_identity.appag_umid",
                    "expressions": {
                        "location": {
                            "references": [
                                "azurerm_resource_group.rg.location",
            ...
            "resources": [
                    ...
                    "values": {
                        ...
                        "http_listener": [
                            ...
                            },
                            {
                                ...
                                "protocol": "Https",
                                "require_sni": null,
                                "ssl_certificate_name": "keyvault-my-cert-1",
                                "ssl_profile_name": ""
                            }
                        ],
                        "identity": [
                        ...
                        "request_routing_rule": [
                            {
                                ...
                                "priority": 9,
                                "redirect_configuration_name": "hr-dev-vnet-rdrcfg",
                ...
                },
                {
                    ...
                    "values": {
                        "certificate": [
                            {
                                "contents": "",
                                "password": "bukhari"
                            }
                        ],
                        "certificate_policy": [
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "parallelism": 8,
                        "size": 0,
                        "source": "./custom-error-pages/403.html",
                        "source_content": null,
                        "source_uri": null,
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "parallelism": 8,
                        "size": 0,
                        "source": "./custom-error-pages/502.html",
                        "source_content": null,
                        "source_uri": null,
                        "storage_container_name": "$web",
                        "timeouts": null,
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "parallelism": 8,
                        "size": 0,
                        "source": "./custom-error-pages/error.html",
                        "source_content": null,
                        "source_uri": null,
                        "storage_container_name": "$web",
                        "timeouts": null,
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "parallelism": 8,
                        "size": 0,
                        "source": "./custom-error-pages/index.html",
                        "source_content": null,
                        "source_uri": null,
                        "storage_container_name": "$web",
                        "timeouts": null,
                    ...
                    "certificate_policy": [
                        {
                            ...
                            "x509_certificate_properties": true
                        }
                    ],
                    "id": true,
                    "key_vault_id": true,
    ...
    "terraform_version": "1.9.4",
    "timestamp": "2024-08-23T00:13:10Z",
    "variables": {
        "ag_subnet_address": {
            "value": [
                "10.1.51.0/24"
