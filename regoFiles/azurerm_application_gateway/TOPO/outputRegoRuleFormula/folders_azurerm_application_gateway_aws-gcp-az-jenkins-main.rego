...
mock_config := {
        ...
        "root_module": {
            "outputs": {
                ...
                "waflab_appgw_url": {
                    ...
                    "expression": {
                        "references": [
                            "azurerm_public_ip.waflab_appgw.ip_address",
                            "azurerm_public_ip.waflab_appgw"
                        ]
                    }
                },
                "waflab_vm_ip_address": {
            ...
            "resources": [
                {
                    "address": "azurerm_application_gateway.waflab",
                    "expressions": {
                        "backend_address_pool": [
                            {
                                ...
                                "name": {
                                    "constant_value": "backend-address-pool"
                                }
                            }
                        ],
                        "backend_http_settings": [
                            {
                                ...
                                "name": {
                                    "constant_value": "backend-http-settings"
                                },
                                "path": {
                                    "constant_value": "/"
                                },
                        ...
                        "firewall_policy_id": {
                            "references": [
                                "azurerm_web_application_firewall_policy.waflab_policy.id",
                                "azurerm_web_application_firewall_policy.waflab_policy"
                            ]
                        },
                        "frontend_ip_configuration": [
                            {
                                "name": {
                                    "constant_value": "frontend-ip-configuration"
                                },
                                "public_ip_address_id": {
                                    "references": [
                                        "azurerm_public_ip.waflab_appgw.id",
                                        "azurerm_public_ip.waflab_appgw"
                                    ]
                                }
                            }
                        ...
                        "gateway_ip_configuration": [
                            {
                                "name": {
                                    "constant_value": "gateway-ip-configuration"
                                },
                                "subnet_id": {
                                    "references": [
                                        "azurerm_subnet.waflab_appgw.id",
                                        "azurerm_subnet.waflab_appgw"
                                    ]
                                }
                            }
                        ],
                        ...
                        "location": {
                            "references": [
                                "azurerm_resource_group.waflab.location",
                                "azurerm_resource_group.waflab"
                            ]
                        },
                        "name": {
                            "constant_value": "waflab-appgw"
                        },
                        "request_routing_rule": [
                            {
                                ...
                                "name": {
                                    "constant_value": "request-routing-rule"
                                },
                                "rule_type": {
                        ...
                        "resource_group_name": {
                            "references": [
                                "azurerm_resource_group.waflab.name",
                                "azurerm_resource_group.waflab"
                            ]
                        },
                        "sku": [
                ...
                {
                    "address": "azurerm_linux_virtual_machine.waflab",
                    "expressions": {
                        "admin_ssh_key": [
                            {
                                "public_key": {
                        ...
                        "name": {
                            "constant_value": "waflab-juiceshop-VM"
                        },
                        "network_interface_ids": {
                            "references": [
                                "azurerm_network_interface.waflab.id",
                                "azurerm_network_interface.waflab"
                            ]
                        },
                        "os_disk": [
                            {
                        ...
                        "source_image_reference": [
                            {
                                ...
                                "sku": {
                                    "constant_value": "20_04-lts-gen2"
                                },
                                "version": {
                                    "constant_value": "20.04.202209200"
                                }
                            }
                        ]
                    },
                ...
                {
                    "address": "azurerm_network_interface.waflab",
                    "expressions": {
                        "ip_configuration": [
                            {
                                "name": {
                                ...
                                "public_ip_address_id": {
                                    "references": [
                                        "azurerm_public_ip.waflab_nic.id",
                                        "azurerm_public_ip.waflab_nic"
                                    ]
                                },
                                "subnet_id": {
                                    "references": [
                                        "azurerm_subnet.waflab.id",
                                        "azurerm_subnet.waflab"
                                    ]
                                }
                            }
                        ],
                ...
                {
                    "address": "azurerm_public_ip.waflab_appgw",
                    "expressions": {
                        "allocation_method": {
                        ...
                        "name": {
                            "constant_value": "waflab-appgw-pip"
                        },
                        "resource_group_name": {
                            "references": [
                                "azurerm_resource_group.waflab.name",
                ...
                {
                    "address": "azurerm_public_ip.waflab_nic",
                    "expressions": {
                        "allocation_method": {
                            "constant_value": "Static"
                        },
                ...
                {
                    "address": "azurerm_resource_group.waflab",
                    "expressions": {
                        "location": {
                            "constant_value": "West Europe"
                        },
                        "name": {
                            "constant_value": "waflab-resources"
                        }
                    },
                    "mode": "managed",
                    "name": "waflab",
                ...
                },
                {
                    ...
                    "expressions": {
                        ...
                        "virtual_network_name": {
                            "references": [
                                "azurerm_virtual_network.waflab.name",
                                "azurerm_virtual_network.waflab"
                            ]
                        }
                    },
                    "mode": "managed",
                ...
                {
                    "address": "azurerm_subnet.waflab_appgw",
                    "expressions": {
                        "address_prefixes": {
                            "constant_value": [
                                "10.0.3.0/24"
                ...
                {
                    "address": "azurerm_virtual_network.waflab",
                    "expressions": {
                        "address_space": {
                            "constant_value": [
                                "10.0.0.0/16"
                ...
                {
                    "address": "azurerm_web_application_firewall_policy.waflab_policy",
                    "expressions": {
                        "custom_rules": [
                            {
                                "action": {
                                ...
                                "exclusion": [
                                    {
                                        ...
                                        "selector": {
                                            "constant_value": "x-company-secret-header"
                                        },
            ...
            "resources": [
                {
                    ...
                    "values": {
                        ...
                        "resource_group_name": "waflab-resources",
                        "rewrite_rule_set": [],
                        "sku": [
                            {
                                "capacity": 2,
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "timeouts": null,
                        "virtual_network_name": "waflab-network"
                    }
                },
                {
                    "address": "azurerm_subnet.waflab_appgw",
    ...
    "timestamp": "2024-08-16T23:50:40Z",
    "variables": {
        "AZURE_CLIENT_ID": {
            "value": ""
        },
