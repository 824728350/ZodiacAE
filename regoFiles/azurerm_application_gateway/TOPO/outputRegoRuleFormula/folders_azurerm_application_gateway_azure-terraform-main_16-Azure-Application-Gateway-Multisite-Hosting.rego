...
mock_config := {
        ...
        "root_module": {
            "outputs": {
                "app1_web_vmss_id": {
                    ...
                    "expression": {
                        "references": [
                            "azurerm_linux_virtual_machine_scale_set.app1_web_vmss.id",
                            "azurerm_linux_virtual_machine_scale_set.app1_web_vmss"
                        ]
                    }
                },
                "app2_web_vmss_id": {
                    ...
                    "expression": {
                        "references": [
                            "azurerm_linux_virtual_machine_scale_set.app2_web_vmss.id",
                            "azurerm_linux_virtual_machine_scale_set.app2_web_vmss"
                        ]
                    }
                },
                "virtual_network_id": {
            ...
            "resources": [
                    ...
                    "expressions": {
                        ...
                        "backend_address_pool": [
                            ...
                            },
                            {
                                "name": {
                                    "references": [
                                        "local.backend_address_pool_name_app2"
                                    ]
                                }
                            }
                        ],
                        ...
                        "http_listener": [
                            {
                                ...
                                "host_names": {
                                    "constant_value": [
                                        "app1.digitaldense.com"
                                    ]
                                },
                                "name": {
                                    "references": [
                                        "local.listener_name_app1"
                                    ]
                                },
                                "protocol": {
                                    "constant_value": "Http"
                            ...
                            },
                            {
                                ...
                                "host_names": {
                                    "constant_value": [
                                        "app2.digitaldense.com"
                                    ]
                                },
                                "name": {
                                    "references": [
                                        "local.listener_name_app2"
                                    ]
                                },
                                "protocol": {
                                    "constant_value": "Http"
                        ...
                        "probe": [
                            ...
                            },
                            {
                                ...
                                "path": {
                                    "constant_value": "/app2/status.html"
                                },
                                "port": {
                                    "constant_value": 80
                                },
                        ...
                        "request_routing_rule": [
                            {
                                ...
                                "name": {
                                    "references": [
                                        "local.request_routing_rule1_name_app1"
                                    ]
                                },
                                "priority": {
                                    "constant_value": 200
                            ...
                            },
                            {
                                ...
                                "name": {
                                    "references": [
                                        "local.request_routing_rule1_name_app2"
                                    ]
                                },
                                "priority": {
                                    "constant_value": 100
                ...
                {
                    "address": "azurerm_linux_virtual_machine_scale_set.app1_web_vmss",
                    "expressions": {
                        "admin_ssh_key": [
                            {
                                "public_key": {
                        ...
                        "network_interface": [
                            {
                                ...
                                "name": {
                                    "constant_value": "app1-web-vmss-nic"
                                },
                                "network_security_group_id": {
                                    "references": [
                                        "azurerm_network_security_group.app1_web_vmss_nsg.id",
                                        "azurerm_network_security_group.app1_web_vmss_nsg"
                                    ]
                                },
                                "primary": {
                                    "constant_value": true
                ...
                {
                    "address": "azurerm_linux_virtual_machine_scale_set.app2_web_vmss",
                    "expressions": {
                        "admin_ssh_key": [
                            {
                                "public_key": {
                        ...
                        "network_interface": [
                            {
                                ...
                                "name": {
                                    "constant_value": "app2-web-vmss-nic"
                                },
                                "network_security_group_id": {
                                    "references": [
                                        "azurerm_network_security_group.app2_web_vmss_nsg.id",
                                        "azurerm_network_security_group.app2_web_vmss_nsg"
                                    ]
                                },
                                "primary": {
                                    "constant_value": true
                ...
                {
                    "address": "azurerm_monitor_autoscale_setting.app1_web_vmss_autoscale",
                    "expressions": {
                        "location": {
                            "references": [
                                "azurerm_resource_group.rg.location",
                    ...
                    "mode": "managed",
                    "name": "app1_web_vmss_autoscale",
                    "provider_config_key": "azurerm",
                    "schema_version": 2,
                    "type": "azurerm_monitor_autoscale_setting"
                },
                {
                    "address": "azurerm_monitor_autoscale_setting.app2_web_vmss_autoscale",
                    "expressions": {
                        "location": {
                            "references": [
                                "azurerm_resource_group.rg.location",
                ...
                {
                    "address": "azurerm_network_security_group.app1_web_vmss_nsg",
                    "expressions": {
                        "location": {
                            "references": [
                                "azurerm_resource_group.rg.location",
                    ...
                    "mode": "managed",
                    "name": "app1_web_vmss_nsg",
                    "provider_config_key": "azurerm",
                    "schema_version": 0,
                    "type": "azurerm_network_security_group"
                },
                {
                    "address": "azurerm_network_security_group.app2_web_vmss_nsg",
                    "expressions": {
                        "location": {
                            "references": [
                                "azurerm_resource_group.rg.location",
            ...
            "variables": {
                ...
                "app1_web_vmss_nsg_inbound_ports": {
                    "default": [
                        "22",
                        "80",
                        "443"
                ...
                "app2_web_vmss_nsg_inbound_ports": {
                    "default": [
                        "22",
                        "80",
                        "443"
            ...
            "resources": [
                    ...
                    "values": {
                        ...
                        "backend_http_settings": [
                            ...
                            },
                            {
                                ...
                                "cookie_based_affinity": "Disabled",
                                "host_name": "",
                                "name": "hr-dev-vnet-be-htst-app2",
                                "path": "",
                                "pick_host_name_from_backend_address": false,
                                "port": 80,
                                "probe_name": "hr-dev-vnet-be-probe-app2",
                                "protocol": "Http",
                                "request_timeout": 60,
                                "trusted_root_certificate_names": []
                            }
                        ...
                        "http_listener": [
                            {
                                ...
                                "name": "hr-dev-vnet-httplstn-app1",
                                "protocol": "Http",
                                "require_sni": null,
                            ...
                            },
                            {
                                ...
                                "name": "hr-dev-vnet-httplstn-app2",
                                "protocol": "Http",
                                "require_sni": null,
                                "ssl_certificate_name": "",
                                "ssl_profile_name": ""
                        ...
                        "probe": [
                            ...
                            },
                            {
                                ...
                                "minimum_servers": 0,
                                "name": "hr-dev-vnet-be-probe-app2",
                        ...
                        "request_routing_rule": [
                            {
                                ...
                                "http_listener_name": "hr-dev-vnet-httplstn-app1",
                                "name": "hr-dev-vnet-rqrt-app1",
                                "priority": 200,
                            ...
                            {
                                "backend_address_pool_name": "hr-dev-vnet-beap-app2",
                                "backend_http_settings_name": "hr-dev-vnet-be-htst-app2",
                                "http_listener_name": "hr-dev-vnet-httplstn-app2",
                                "name": "hr-dev-vnet-rqrt-app2",
                                "priority": 100,
                                "redirect_configuration_name": "",
                                "rewrite_rule_set_name": "",
                                "rule_type": "Basic",
                ...
                },
                {
                    ...
                    "values": {
                        ...
                        "boot_diagnostics": [],
                        "capacity_reservation_group_id": null,
                        "custom_data": "",
                        "data_disk": [],
                        "disable_password_authentication": true,
                        "do_not_run_extensions_on_overprovisioned_machines": false,
                        "edge_zone": null,
                ...
                },
                {
                    ...
                    "values": {
                        "enabled": true,
                        "location": "eastus",
                        "name": "hr-dev-app1-web-vmss-autoscale-profiles",
                        "notification": [
                            {
                                "email": [
                                    {
                ...
                },
                {
                    ...
                    "values": {
                        "enabled": true,
                        "location": "eastus",
                        "name": "hr-dev-app2-web-vmss-autoscale-profiles",
                        "notification": [
                            {
                                "email": [
                                    {
    ...
    "terraform_version": "1.9.4",
    "timestamp": "2024-08-23T00:13:09Z",
    "variables": {
        "ag_subnet_address": {
            "value": [
                "10.1.51.0/24"
